...
rowLen1 = 0
fileHandler = open('D:\\Masters Program Chalmers\\Projects and Labs\\ANN\\HW3_Task4_Player1.csv', 'r', newline="")
with fileHandler:
...
rowLen2 = 0
fileHandler = open('D:\\Masters Program Chalmers\\Projects and Labs\\ANN\\HW3_Task4_Player2.csv', 'r', newline="")
with fileHandler:
    read = csv.reader(fileHandler)
    for row in read:
